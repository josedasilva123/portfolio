...
export const BaseTitle: React.FC<iTitle> = ({ children, className, titleTag, tabIndex }) => {
  return (
    <>
      {titleTag === "h1" && <h1 className={className} tabIndex={tabIndex}>{children}</h1>} 
      {titleTag === "h2" && <h2 className={className} tabIndex={tabIndex}>{children}</h2>} 
      {titleTag === "h3" && <h3 className={className} tabIndex={tabIndex}>{children}</h3>} 
      {titleTag === "h4" && <h4 className={className} tabIndex={tabIndex}>{children}</h4>} 
      {titleTag === "h5" && <h5 className={className} tabIndex={tabIndex}>{children}</h5>} 
      {titleTag === "h6" && <h6 className={className} tabIndex={tabIndex}>{children}</h6>} 
      {titleTag === "p" && <p className={className} tabIndex={tabIndex}>{children}</p>} 
    </>
  )
}
